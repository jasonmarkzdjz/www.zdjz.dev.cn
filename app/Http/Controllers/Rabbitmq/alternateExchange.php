...
$voteExchange->setArgument('alternate-exchange',$alter_nate_exchange);//绑定备份交换器
...
$voteQuene->bind($voteExchangeName,$voteBindKey);
...
$alternateExchange->setType(AMQP_EX_TYPE_FANOUT);//备份交换器的交换器类型设置为fanout
...
$alternateQuene->bind($alter_nate_exchange,$alter_nage_bind_key);//备份交换器通过bindKey与队列进行绑定

<?php
namespace library\Service\ApiSpeech\lib;
/*
...
use library\Service\ApiSpeech\lib\AipHttpClient;
use library\Service\ApiSpeech\lib\AipBCEUtil;
use library\Service\ApiSpeech\lib\AeAipImageUtils;
/**
 * Aip Base 基类
 */
class AipBase {
